							...
							<div class="regui" style="z-index: -1;">
						            <div class="regcontainer" >
						                <form id="contact" action="" method="post" style="margin: 5%;z-index: 1;">
						                    ...
						                    <fieldset>
						                        <input placeholder="Nickname" type="text" tabindex="2" required autofocus>
						                    </fieldset>
						                    <fieldset>
						                        <input id="password" placeholder="Password" type="password" tabindex="3" required>
						                    </fieldset>
						                    <fieldset>
						                        <input id="confirm_password" placeholder="Confirm Password" type="password" tabindex="4" required>
						                    </fieldset>
						                    <fieldset>
